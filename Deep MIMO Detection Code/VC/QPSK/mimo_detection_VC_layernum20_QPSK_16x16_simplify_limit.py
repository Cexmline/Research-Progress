...
LOGDIR = "path/layernum20/16x16/5000-simplify-residual"
...
xkout12 = np.zeros((2 * K, testsymbolnum))
xkout16 = np.zeros((2 * K, testsymbolnum))
xkout20 = np.zeros((2 * K, testsymbolnum))
layernum = 5
...
scipy.io.savemat('result/layernum20/16x16/simplify/ber.mat', {'ber': ber})
scipy.io.savemat('result/layernum20/16x16/simplify/xkout20_complex_seq.mat',
                 {'xkout20_complex_seq': xkout20_complex_seq})
scipy.io.savemat('result/layernum20/16x16/simplify/x20.mat', {'x20': xkout20bit_seq})
scipy.io.savemat('result/layernum20/16x16/simplify/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum20/16x16/simplify/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum20_simplify_5000_16*16_end")
print("end")
