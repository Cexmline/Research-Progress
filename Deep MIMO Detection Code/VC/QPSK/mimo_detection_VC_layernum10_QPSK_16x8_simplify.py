...
LOGDIR = "path/layernum10/16x8/5000-simplify-residual"
K = 8  # Number of users
...
scipy.io.savemat('result/layernum10/16x8/simplify/ber.mat', {'ber': ber})
scipy.io.savemat('result/layernum10/16x8/simplify/xkout10_complex_seq.mat', {'xkout10_complex_seq': xkout10_complex_seq})
scipy.io.savemat('result/layernum10/16x8/simplify/x10.mat', {'x10': xkout10bit_seq})
scipy.io.savemat('result/layernum10/16x8/simplify/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum10/16x8/simplify/berdecorSet.mat', {'berdecorSet': berdecorSet})
