...
LOGDIR="path/layernum4/8x4/Hn1-18"
K=4  #Number of users
...
def generate_data(batchsize,K,N,H,mod_Type,mod_Name):
	...
	for m in range(batchsize):
		SNR = np.random.uniform(8, 18, 1)  ##8dB-13dB uniform distribution
...
layernum=4
ber=np.zeros((layernum,10))
berdecorSet=np.zeros((1,10))
indexcount=0

for i1 in range (8,18):
...
scipy.io.savemat('result/layernum4/8x4/Hn1-18/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum4/8x4/Hn1-18/x4.mat', {'x4': xkout4bit_seq})
scipy.io.savemat('result/layernum4/8x4/Hn1-18/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum4/8x4/Hn1-18/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum4_Hn1_5000_8x4_end")
print("end")