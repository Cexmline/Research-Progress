...
LOGDIR="path/layernum7/Hn4weightlarge/combine"
K=4  #Number of users
N=8 #Number of receiving antenna
batch_size=50000 #Define the batch size
STEPS=150000  #Number of iteration
Hdata=scipy.io.loadmat('Hn4_9.9104')
H=Hdata['Hn4']
H=H.astype('float32')
...
with tf.name_scope('layer2'):
	...
	cal2_1=tf.matmul(w21,z1)+b21+k1*x1
...
with tf.name_scope('layer3'):
	...
	cal2_2=tf.matmul(w22,z2)+b22+k2*x2
...
with tf.name_scope('layer4'):
	...
	cal2_3=tf.matmul(w23,z3)+b23+k3*x3
...
with tf.name_scope('layer5'):
	...
	cal2_4=tf.matmul(w24,z4)+b24+k4*x4
...
with tf.name_scope('layer6'):
	...
	cal2_5=tf.matmul(w25,z5)+b25+k5*x5
...
with tf.name_scope('layer7'):
	...
	k6 = tf.Variable(0.5, name='k6')
	cal2_6=tf.matmul(w26,z6)+b26+k6*x6
...
for i1 in range (8,14):
	...
	scipy.io.savemat('data/layernum7/Hn4weightl/150000/SNR%d/source.mat'%i1, {'source': sourcetest_mat})
	scipy.io.savemat('data/layernum7/Hn4weightl/150000/SNR%d/x1.mat'%i1, {'x1': xkout1})
	scipy.io.savemat('data/layernum7/Hn4weightl/150000/SNR%d/x2.mat'%i1, {'x2': xkout2})
	scipy.io.savemat('data/layernum7/Hn4weightl/150000/SNR%d/x3.mat'%i1, {'x3': xkout3})
	scipy.io.savemat('data/layernum7/Hn4weightl/150000/SNR%d/x4.mat'%i1, {'x4': xkout4})
	scipy.io.savemat('data/layernum7/Hn4weightl/150000/SNR%d/x5.mat'%i1, {'x5': xkout5})
	scipy.io.savemat('data/layernum7/Hn4weightl/150000/SNR%d/x6.mat'%i1, {'x6': xkout6})
	scipy.io.savemat('data/layernum7/Hn4weightl/150000/SNR%d/x7.mat'%i1, {'x7': xkout7})
	...
	scipy.io.savemat('data/layernum7/Hn4weightl/150000/SNR%d/y.mat'%i1, {'y': y_test})
...
sess.close()
print("layernum7_Hn4weight_150000combine_8*4_end")
print("end")