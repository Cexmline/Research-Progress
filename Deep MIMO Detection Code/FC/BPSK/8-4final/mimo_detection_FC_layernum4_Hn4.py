...
for i1 in range (8,14):
	...
	scipy.io.savemat('data/layernum4/Hn4/SNR%d/source.mat'%i1, {'source': sourcetest_mat})
	scipy.io.savemat('data/layernum4/Hn4/SNR%d/x1.mat'%i1, {'x1': xkout1})
	scipy.io.savemat('data/layernum4/Hn4/SNR%d/x2.mat'%i1, {'x2': xkout2})
	scipy.io.savemat('data/layernum4/Hn4/SNR%d/x3.mat'%i1, {'x3': xkout3})
	scipy.io.savemat('data/layernum4/Hn4/SNR%d/x4.mat'%i1, {'x4': xkout4})
	...
	scipy.io.savemat('data/layernum4/Hn4/SNR%d/y.mat'%i1, {'y': y_test})
...
sess.close()
print("layernum4_Hn4_50000_8*4_end")
print("end")