...
LOGDIR="path/layernum2/8x4/HRn1-11.7763"
K=4  #Number of users
...
Hdata=scipy.io.loadmat('HRn1_8x4_11.7763')
H=Hdata['HRn1']
...
scipy.io.savemat('result/layernum2/8x4/HRn1/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum2/8x4/HRn1/x2.mat', {'x2': xkout2bit_seq})
scipy.io.savemat('result/layernum2/8x4/HRn1/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum2/8x4/HRn1/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum2_HRn1_5000_8*4_end")
print("end")