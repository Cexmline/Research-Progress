...
LOGDIR="path/layernum2/8x4/Hn1-8.8505"
K=4  #Number of users
...
Hdata=scipy.io.loadmat('Hn1_8x4_8.8505')
H=Hdata['Hn1']
...
scipy.io.savemat('result/layernum2/8x4/Hn1/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum2/8x4/Hn1/x2.mat', {'x2': xkout2bit_seq})
scipy.io.savemat('result/layernum2/8x4/Hn1/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum2/8x4/Hn1/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum2_Hn1_5000_8*4_end")
print("end")