...
LOGDIR="path/layernum2/8x4/Hn2-7.9228"
K=4  #Number of users
...
Hdata=scipy.io.loadmat('Hn2_8x4_7.9228')
H=Hdata['Hn2']
...
scipy.io.savemat('result/layernum2/8x4/Hn2/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum2/8x4/Hn2/x2.mat', {'x2': xkout2bit_seq})
scipy.io.savemat('result/layernum2/8x4/Hn2/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum2/8x4/Hn2/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum2_Hn2_5000_8*4_end")
print("end")