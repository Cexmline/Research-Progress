...
LOGDIR = "path/layernum6/40x20/Hn1-7.2177-norelu"
...
scipy.io.savemat('result/layernum6/40x20/norelu/Hn1/ber.mat', {'ber': ber})
scipy.io.savemat('result/layernum6/40x20/norelu/Hn1/xkout6_complex_seq.mat', {'xkout6_complex_seq': xkout6_complex_seq})
scipy.io.savemat('result/layernum6/40x20/norelu/Hn1/x6.mat', {'x6': xkout6bit_seq})
scipy.io.savemat('result/layernum6/40x20/norelu/Hn1/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum6/40x20/norelu/Hn1/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum6_Hn1_norelu_5000_40*20_end")
print("end")
