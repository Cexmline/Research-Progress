...
LOGDIR="path/layernum2/16x8/Hn3-7.2562"
K=8  #Number of users
...
scipy.io.savemat('result/layernum2/16x8/Hn3/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum2/16x8/Hn3/x2.mat', {'x2': xkout2bit_seq})
scipy.io.savemat('result/layernum2/16x8/Hn3/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum2/16x8/Hn3/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum2_Hn3_5000_16*8_end")
print("end")