...
LOGDIR="path/layernum2/16x8/Hn2-7.1812"
K=8  #Number of users
...
Hdata=scipy.io.loadmat('Hn2_16x8_7.1812')
H=Hdata['Hn2']
...
scipy.io.savemat('result/layernum2/16x8/Hn2/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum2/16x8/Hn2/x2.mat', {'x2': xkout2bit_seq})
scipy.io.savemat('result/layernum2/16x8/Hn2/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum2/16x8/Hn2/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum2_Hn2_5000_16*8_end")
print("end")