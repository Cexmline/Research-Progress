...
LOGDIR="path/layernum2/16x8/Hn3-norelu"
K=8  #Number of users
...
scipy.io.savemat('result/layernum2/16x8/norelu/Hn3/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum2/16x8/norelu/Hn3/x2.mat', {'x2': xkout2bit_seq})
scipy.io.savemat('result/layernum2/16x8/norelu/Hn3/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum2/16x8/norelu/Hn3/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum2_Hn3_norelu_5000_16*8_end")
print("end")