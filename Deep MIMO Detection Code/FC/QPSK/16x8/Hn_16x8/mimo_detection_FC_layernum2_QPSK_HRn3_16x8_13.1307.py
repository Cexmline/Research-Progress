...
LOGDIR="path/layernum2/16x8/HRn3-13.1307"
K=8  #Number of users
...
Hdata=scipy.io.loadmat('HRn3_16x8_13.1307')
H=Hdata['HRn3']
...
scipy.io.savemat('result/layernum2/16x8/HRn3/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum2/16x8/HRn3/x2.mat', {'x2': xkout2bit_seq})
scipy.io.savemat('result/layernum2/16x8/HRn3/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum2/16x8/HRn3/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum2_HRn3_5000_16*8_end")
print("end")