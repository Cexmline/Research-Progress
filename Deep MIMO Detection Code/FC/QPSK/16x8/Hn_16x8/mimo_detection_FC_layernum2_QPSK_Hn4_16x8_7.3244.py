...
LOGDIR="path/layernum2/16x8/Hn4-7.3244"
K=8  #Number of users
...
Hdata=scipy.io.loadmat('Hn4_16x8_7.3244')
H=Hdata['Hn4']
...
scipy.io.savemat('result/layernum2/16x8/Hn4/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum2/16x8/Hn4/x2.mat', {'x2': xkout2bit_seq})
scipy.io.savemat('result/layernum2/16x8/Hn4/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum2/16x8/Hn4/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum2_Hn4_5000_16*8_end")
print("end")