...
LOGDIR="path/layernum4/16x8/Hn3-7.2562"
K=8  #Number of users
...
scipy.io.savemat('result/layernum4/16x8/Hn3/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum4/16x8/Hn3/xkout4_complex_seq.mat',{'xkout4_complex_seq':xkout4_complex_seq})
scipy.io.savemat('result/layernum4/16x8/Hn3/x4.mat', {'x4': xkout4bit_seq})
scipy.io.savemat('result/layernum4/16x8/Hn3/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum4/16x8/Hn3/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum4_Hn3_5000_16*8_end")
print("end")