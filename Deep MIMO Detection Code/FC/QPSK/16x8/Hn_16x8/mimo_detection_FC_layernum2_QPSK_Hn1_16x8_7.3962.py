...
LOGDIR="path/layernum2/16x8/Hn1-7.3962"
K=8  #Number of users
...
scipy.io.savemat('result/layernum2/16x8/Hn1/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum2/16x8/Hn1/x2.mat', {'x2': xkout2bit_seq})
scipy.io.savemat('result/layernum2/16x8/Hn1/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum2/16x8/Hn1/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum2_Hn1_5000_16*8_end")
print("end")