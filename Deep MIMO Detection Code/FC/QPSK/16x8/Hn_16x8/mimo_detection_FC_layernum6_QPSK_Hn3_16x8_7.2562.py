...
LOGDIR = "path/layernum6/16x8/Hn3-7.2562"
K = 8  # Number of users
...
scipy.io.savemat('result/layernum6/16x8/Hn3/ber.mat', {'ber': ber})
scipy.io.savemat('result/layernum6/16x8/Hn3/xkout6_complex_seq.mat', {'xkout6_complex_seq': xkout6_complex_seq})
scipy.io.savemat('result/layernum6/16x8/Hn3/x6.mat', {'x6': xkout6bit_seq})
scipy.io.savemat('result/layernum6/16x8/Hn3/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum6/16x8/Hn3/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum6_Hn3_5000_16*8_end")
print("end")
