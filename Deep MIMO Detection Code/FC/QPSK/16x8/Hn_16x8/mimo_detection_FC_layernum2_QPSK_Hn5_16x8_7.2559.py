...
LOGDIR="path/layernum2/16x8/Hn5-7.2559"
K=8  #Number of users
...
scipy.io.savemat('result/layernum2/16x8/Hn5/ber.mat',{'ber':ber})
scipy.io.savemat('result/layernum2/16x8/Hn5/x2.mat', {'x2': xkout2bit_seq})
scipy.io.savemat('result/layernum2/16x8/Hn5/source.mat', {'source': source_test})
scipy.io.savemat('result/layernum2/16x8/Hn5/berdecorSet.mat', {'berdecorSet': berdecorSet})

sess.close()
print("layernum2_Hn5_5000_16*8_end")
print("end")