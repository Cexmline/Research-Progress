...
nTrainSymbol=2^20; %number of symbols
switch modType
  case 256
       hMod = hMod256;
  case 128
...
param=[0.9 0.7 0.5 0.6 0.5 0.5 0.3 0.1 0.1];%
...
%% Validation 
nValidSymbol=1.008*10^6;
rng(112);
ValidSource=randi([0 1],nValidSymbol*input_layer_size,1);
...
ThreMatrix_Valid=0.5*ones(ClassNumber,nValidSymbol);
